  ...
  public function run()
  {
    DB::table("products")->insert([
      [
        ...
        'price' => 9.95,
        'category' => 1,
        'image' => 'assets/image/products/salatalık.jpg',
      ...
      [
        ...
        'price' => 16.95,
        'category' => 1,
        'image' => 'assets/image/products/domates-salkim.jpg',
      ...
      [
        ...
        'price' => 120.47,
        'category' => 2,
        'image' => 'assets/image/products/DanaKıymalık.jpg',
      ...
      [
        ...
        'price' => 52.72,
        'category' => 2,
        'image' => 'assets/image/products/BanvitPiliçBaget.jpg',
      ...
      [
        ...
        'price' => 13.95,
        'category' => 3,
        'image' => 'assets/image/products/LaysBaharatlıPatatesCipsi.jpg',
      ...
      [
        ...
        'price' => 8.95,
        'category' => 3,
        'image' => 'assets/image/products/ÜlkerBitterKareÇikolata.jpg',
      ...
      [
        ...
        'price' => 61.95,
        'category' => 4,
        'image' => 'assets/image/products/DoğadanEarlGreyDemlikPoşetÇay.jpg',
        'description' => 'Kakao kitlesi, şeker, kakao tozu, sade yağ (süt), emülgatörler (soya lesitini, poligliserol polirisinoleat), aroma verici. Kakao kuru maddesi en az %80?dır. Eser miktarda yer fıstığı, sert kabuklu meyveler, yumurta ürünü ve gluten içerebilir. Domuz yağı ve katkıları içermez.',
        'created_at' => now(),
        'updated_at' => now(),
      ],
