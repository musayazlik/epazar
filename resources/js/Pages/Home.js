...
export default function Home(props) {
  ...
  return (
    <>
      ...
      <div className=" flex justify-between h-[64px] text-white bg-gray-700 dark:bg-gray-900 items-center sm:pt-0 mb-20">
        <div className="container mx-auto">
          <div className="flex justify-between items-center">
            <div className="logo">
              <img
                src="assets/image/HomeLogo.png"
                alt="logo"
      ...
      <div className="container mx-auto">
        <div className="flex justify-center sm:grid sm:grid-cols-12 gap-x-9">
          ...
          <div className="col-span-7 xl:col-span-9 justify-center">
